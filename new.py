...
root.configure(bg="#40AAB8")
root.minsize(800, 500)
root.maxsize(800, 500)


frame = Frame(root, bg="#80fff2", bd=5)
...
def update():
    ...
    if(t!=""):
        ...
        app_name_label_edit.grid(row=0, column=0, pady=10)
        url_label_edit = Label(edit, text="URL:")
        url_label_edit.grid(row=1, column=0, pady=10)
        email_id_label_edit = Label(edit, text="Email Id:")
        email_id_label_edit.grid(row=2, column=0, pady=10)
        password_label_edit = Label(edit, text="Password:")
        password_label_edit.grid(row=3, column=0, pady=10)
...
#query_btn = Button(root, text = "MISSING IMAGE", command = query)
#query_btn.grid(row=0,column=3, pady=5, padx=5, ipadx=105,ipady= 75)
